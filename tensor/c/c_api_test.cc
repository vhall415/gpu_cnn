...
#include "../c/c_test_util.h"
#include "../cc/saved_model/signature_constants.h"
#include "../cc/saved_model/tag_constants.h"
#include "../core/example/example.pb.h"
#include "../core/example/feature.pb.h"
#include "../core/framework/api_def.pb.h"
#include "../core/framework/common_shape_fns.h"
#include "../core/framework/graph.pb_text.h"
#include "../core/framework/node_def.pb_text.h"
...
#include "../core/util/equal_graph_def.h"
...
TEST(CAPI, MalformedTensor) {
  // See https://github.com/../../issues/7394
...
TEST(CAPI, LibraryLoadFunctions) {
  ...
  TF_Library* lib =
      TF_LoadLibrary("../c/test_op.so", status);
